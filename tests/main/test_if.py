...
- stage1:
    stg1:
    - in: 0
    # stg3 состоит параллельно из st1 и st2,
    # но так как они не выполнились, то []
...
- stage1:
    stg1:
    - in: 0
    # stg3 состоит параллельно из st1 и st2, st1 не выполниться,
    # а st2 выполнен, поэтому получим массив из st2 == [20]
